...
public class Node {
	...
	public int id; // identify the tree nodes so that when we pick 2 of them we
					// can find LCA of them
	...
	// // Iterable<INode> iterable= Arrays.asList(children); //
	// http://stackoverflow.com/questions/10335662/convert-java-array-to-iterable
	// return null;
	// }
	//
	// @Override
	...
	/*
	 * Adapted from
	 * http://stackoverflow.com/questions/1649027/how-do-i-print-out
	 * -a-tree-structure It is used with a representational purpose when
	 * checking the outcome (whether we've found the right node).
	 */
